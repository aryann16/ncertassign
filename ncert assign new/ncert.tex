...
\end{table}
\begin{align}
\text{For $X_1$ (Black Die):}\\
\text{PMF of $X_1$:}
P_{X_1}(i) &= 1/6 \text{for i} = 1 to 6\\
\text{CDF of $X_1$:}
F_{X_1}(i) &= i/6 \text{for i}  = 1 to 6\\
\text{For $X_2$ (Red Die):}\\
\text{PMF for $X_2$:}
P_{X_2}(j) &= 1/6 \text{for j} = 1 to 6\\
\text{CDF for $X_2$:}
F_{X_2}(j) &= j/6 \text{for j}  = 1 to 6\\
\end{align}
...
therefore
\begin{align}
\pr{X_1+X_2=8 \mid X_2<4}&=\frac{\frac{2}{9}}{F_{X_2}(4)}\\
&=\frac{1}{9}
\end{align}
