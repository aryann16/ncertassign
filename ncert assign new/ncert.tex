...
&=1-\frac{\pr{X_2 \le 4,X_1 = 5}}{\pr{X_1=5}}\\
&=1-\pr{X_2 \le 4}\\
&=1-F_{X_2}\brak{4}\\
&=1-\frac{4}{6}\\
&=1-\frac{2}{3}\\
...
\end{align}
\item
considering $X_2 < 4$ as a condition
\begin{align}
\implies P_{X_2}\brak{k}=
\begin{cases}
\frac{1}{3} & j=\cbrak{1,2,3}\\
0 & \text{otherwise}
\end{cases}
\end{align}
thus
\begin{align}
\pr{X_1+X_2=8}&=\pr{X_1=8-X_2}\\
&=E\brak{P_{X_1}\brak{8-X_2}}\\
&=\sum_{i=1}^{6}P_{X_1}\brak{8-i}P_{X_2}\brak{i}\\
&=\frac{1}{3}\sum_{i=1}^{3}P_{X_1}\brak{8-i}\\
&=\frac{1}{3}\brak{0+\frac{1}{6}+\frac{1}{6}}\\
&=\frac{1}{9}
\end{align}
\end{enumerate}
\end{document}
