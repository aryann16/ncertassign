...
\begin{cases}
0 & k < 0 \\
\myvec{n\\k}\brak{p}^{k}\brak{q}^{n-k} & 0 \leq k \leq n 
\end{cases}
\end{align}
...
\begin{align}
P_Y(y)&=P_X(k)\\
P_Y(-6)&=\binom{4}{0}\times {\frac{1}{2}}^0 \times {\frac{1}{2}}^4 \\
&=\frac{1}{16}\\
P_Y(=3.5)&=\binom{4}{1}\times {\frac{1}{2}}^1 \times {\frac{1}{2}}^3 \\
&=\frac{1}{4}\\
P_Y(-1)&=\binom{4}{2}\times {\frac{1}{2}}^2 \times {\frac{1}{2}}^2 \\
&=\frac{3}{8}\\
P_Y(1.5)&=\binom{4}{3}\times {\frac{1}{2}}^3 \times {\frac{1}{2}}^1 \\
&=\frac{1}{4}\\
P_Y(4)&=\binom{4}{4}\times {\frac{1}{2}}^4 \times {\frac{1}{2}}^0 \\
&=\frac{1}{16}
\end{align}
\begin{figure}[!ht]
