...
\caption{random variables of white and red ball}
...
\begin{align}
\pr{Y=1}&=\pr{X=1}.\pr{Y=1|X=1}+\pr{X=2}.\pr{Y=1|X=2}+\pr{X=3}.\pr{Y=1|X=3}\\
&=\frac{1}{6}.\frac{3}{3}+\frac{2}{6}.\frac{2}{3}+\frac{3}{6}.0\\
&=\frac{7}{18}
\end{align}
\item
The probability that a white ball will be selected is:
\begin{align}
\pr{Y=0}&=\pr{X=1}.\pr{Y=0|X=1}+\pr{X=2}.\pr{Y=0|X=2}+\pr{X=3}.\pr{Y=0|X=3}\\
&=\frac{1}{6}.0+\frac{2}{6}.\frac{1}{3}+\frac{3}{6}.\frac{3}{3}\\
&=\frac{11}{18}
\end{align}
\end{enumerate}
\end{document}
